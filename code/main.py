...
if __name__ == "__main__":
    ...
    try:
        ...
        # сама интерполяция
        subprocess.run(['./ifrnet-cpu/ifrnet-ncnn-vulkan.exe', '-i', f'{INPUT_FOLDER}', '-o', f'{OUTPUT_FOLDER}'])
        
        # 3. Создаем видео без аудио
        photos_to_video(output_video_path, fps)
        ...
        # 4. Очистка временных папок (выполняется всегда, даже при ошибках)
